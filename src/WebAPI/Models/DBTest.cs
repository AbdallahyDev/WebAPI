...
namespace WebAPI.Models
{
    public class DBTest
    {
        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
            ...
            var ing = new Ingredient() {Calories=44.55f, CategoryId="1" };  
            ...
            var recette = new Recette() { Name = "Tajine", Calories = 155.5f, IsAvailable = true, CategoryName="viande", CreatorId = 1, Comments = null, Preparation = "poulet + pomme de terre" }; 
